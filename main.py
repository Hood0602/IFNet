...
import torch
import random
from models.models import IFNet
from modules.dataloaders import DataLoader
...
def main():
    ...
    # create data loader
    train_dataloader = DataLoader(args, tokenizer, split='train', shuffle=True,drop_last=True)
    val_dataloader = DataLoader(args, tokenizer, split='val', shuffle=False)
    test_dataloader = DataLoader(args, tokenizer, split='test', shuffle=False)

    # build model architecture
    model = IFNet(args, tokenizer)
